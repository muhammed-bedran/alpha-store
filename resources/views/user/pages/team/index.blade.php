...
@section('content')
     <x-flash-message />
        ...
        <a href="{{ route('user.team.create') }}" class="btn btn-primary">Create Team</a>
            ...
            <tbody>
                @foreach ($members as $item)
                    <tr>
                        ...
                        <td>
                            <a class="btn-primary" href="{{ route('user.team.edit', $item->id) }}">
                                Edit
                            </a>
                        </td>
                        <td>
                            <form action="{{ route('user.team.destroy', $item->id) }}" method="post">
                                @csrf
                                @method('DELETE')
